...
# 44 features - one way + features two ways +- 256

#le de um arquivo .pcap
# o outro py separador gera arquivos .pcap com o tamanho do bloco
...
def process_pcap(id_bloco, host_a, proto, service_class, app_class, qos_class, entrada_arquivo_pcap, two_way= True, tcptrace = True, debug=False):
    #ler arquivo
